...
export const isObjectAnyFrozen = (object) => {
  return Object.isExtensible(object) ? false : true;
};
...
export const assignLockedValues = (object, propertyName) => {
  ...
  if (!copyObj.hasOwnProperty(propertyName)) {
    copyObj[propertyName] = null;
  }
  Object.defineProperty(copyObj, propertyName, { writable: false });
  return copyObj;
};
